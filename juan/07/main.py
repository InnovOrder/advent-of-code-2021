...
fuelConsumptionPartTwo = partOneAndTwo(crabPositions, fuelConsumptionBetweenTwoPositionsPartOne)
partOneSmallerValue = getSmallerValueFromDict(fuelConsumptionPartTwo)
